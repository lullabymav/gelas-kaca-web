                                        ...
                                        <ul className="flex flex-row gap-2 items-center text-center text-sm">
                                            ...
                                            <li id="action" className="flex-none w-auto">
                                                <div className="flex gap-2">
                                                    <button className="w-auto bg-blue-500 text-white shadow rounded-2xl p-2">Process Lanjut</button>
                                                    <button className="w-auto border border-black shadow rounded-2xl p-2">Bantuan</button>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
