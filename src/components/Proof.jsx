    ...
    <div className="my-8 mx-12">
      ...
      <div className="mx-80">
        <section className="text-center">
          <h1 className="font-semibold text-2xl mt-8 mb-6">
        ...
        <section className="bg-gray-100 w-9/12 h-auto mx-auto mt-4 rounded-2xl p-6">
          ...
          <section className="flex flex-col gap-2 text-sm">
            ...
            <Link
              to="/success"
              class="btn-in text-center font-semibold w-full py-3 rounded-full transition-all duration-200 px-8 cursor-pointer hover:btn-in hover:opacity-70"
            >
              Kirim & Konfirmasi
            </Link>
          </section>
